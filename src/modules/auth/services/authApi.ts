...
export const authApi = {
  ...
  register: async (credentials: IRegisterCredentials): Promise<ApiResponse<IAuthResponse & { organization?: { id: string; name: string; slug: string }; invitationAccepted?: boolean }>> => {
